...
- **Free (R$ 0):** até 20 produtos, 30 pedidos/mês, cor e logo. *"Ótimo pra começar e testar sem custo."*
- **Pro (sob medida):** produtos e pedidos ilimitados, sua marca sem selo, CRM de clientes fiéis,
  relatórios, QR Code, exportação. *"Pra quem já vende bem e quer crescer sem limite."*

> Não empurre o Pro logo de cara. Se o volume for baixo, comece no Free — a conta migra depois.

## 5. Fechamento / próximo passo

- **"Bora fazer o seguinte:** me manda por aqui uma foto do seu cardápio ou os produtos e preços,
  que eu já deixo sua loja no ar hoje. Aí te mando o link pra você ver."
...
3. Envie o link da loja + login pro cliente no WhatsApp.
4. Marque o lead como **Fechado** no painel.
...
| *"É caro?"* | "Tem o plano grátis, dá pra começar sem pagar nada e ver se funciona pro seu movimento." |
| *"Preciso pensar."* | "Claro! Te deixo a loja pronta no Free sem compromisso — você testa e decide depois. Pode ser?" |
